...
namespace api.Migrations
{
    ...
    [Migration("20241130181539_TotalFlowSummary")]
    partial class TotalFlowSummary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "3ee271c5-d380-479c-945e-266b36b03dd6",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "757ab933-63ff-48cd-b6cc-bc88965fcef0",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("api.Dtos.Transaction.TotalFlowSummaryDto", b =>
                {
                    b.Property<decimal>("SavingPercentage")
                        .HasColumnType("numeric");

                    b.Property<decimal>("SavingTotal")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("api.Models.SavingTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("api.Models.SavingTransaction", b =>
                {
                    ...
                    b.HasOne("api.Models.SavingGoal", "SavingGoal")
                        .WithMany()
