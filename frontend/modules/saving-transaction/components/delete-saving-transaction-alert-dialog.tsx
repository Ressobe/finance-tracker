...
type DeleteSavingTransactionAlertDialogProps = {
  savingTransaction: null;
  children: React.ReactNode;
  closeDropdownMenu?: () => void;
};

export function DeleteSavingTransactionAlertDialog({
  children,
  closeDropdownMenu,
}: DeleteSavingTransactionAlertDialogProps) {
  ...
  //       toast({
  //         description: (
  //           <SucessToastMessage message="Saving transaction deleted!" />
  //         ),
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction disabled={isPending}>Continue</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
  );
